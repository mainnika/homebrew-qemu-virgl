class QemuAT202111031 < Formula
  ...
  depends_on "virglrenderer@20211103.1"
  depends_on "libpng"
  depends_on "libssh"
  depends_on "libusb"
  depends_on "lzo"
  ...
  def install
    ...
    args = %W[
      ...
      --extra-cflags=-I#{Formula["libepoxy@20211103.1"].opt_prefix}/include
      --extra-ldflags=-L#{Formula["libepoxy@20211103.1"].opt_prefix}/lib
      --extra-cflags=-I#{Formula["virglrenderer@20211103.1"].opt_prefix}/include
      --extra-ldflags=-L#{Formula["virglrenderer@20211103.1"].opt_prefix}/lib
